...
public class PortalBlock extends BlockPortal
{
    ...
    {
        PortalBlock.Size blockportal$size = new PortalBlock.Size(worldIn, pos, EnumFacing.Axis.X);
        ...
        {
        	PortalBlock.Size blockportal$size1 = new PortalBlock.Size(worldIn, pos, EnumFacing.Axis.Z);
    ...
    public BlockPattern.PatternHelper createPatternHelper(World worldIn, BlockPos p_181089_2_)
    {
        ...
        PortalBlock.Size blockportal$size = new PortalBlock.Size(worldIn, p_181089_2_, EnumFacing.Axis.X);
        LoadingCache<BlockPos, BlockWorldState> loadingcache = BlockPattern.createLoadingCache(worldIn, true);

        if (!blockportal$size.isValid())
        {
            enumfacing$axis = EnumFacing.Axis.X;
            blockportal$size = new PortalBlock.Size(worldIn, p_181089_2_, EnumFacing.Axis.Z);
        }
    ...
    public static class Size
        {
            ...
            protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_)
            {
                ...
                for (i = 0; i < 22; ++i)
                {
                    ...
                    if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock()) || this.world.getBlockState(blockpos.down()).getBlock() != StartupCommon.portalFrame)
                    {
                        break;
                    }
                }
                ...
                return block == StartupCommon.portalFrame ? i : 0;
            }
            ...
            protected int calculatePortalHeight()
            {
                ...
                for (this.height = 0; this.height < 21; ++this.height)
                {
                    for (int i = 0; i < this.width; ++i)
                    {
                        ...
                        if (block == StartupCommon.portalBlock)
                        {
                        ...
                        if (i == 0)
                        {
                            ...
                            if (block != StartupCommon.portalFrame)
                            {
                                break label24;
                            }
                        }
                ...
                {
                    if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != StartupCommon.portalFrame)
                    {
                        this.height = 0;
                        break;
                    }
            ...
            {
                return blockIn.getMaterial(null) == Material.AIR || blockIn == StartupCommon.magicFire || blockIn == StartupCommon.portalBlock;
            }
            ...
            public void placePortalBlocks()
            {
                for (int i = 0; i < this.width; ++i)
                {
                    ...
                    {
                        this.world.setBlockState(blockpos.up(j), StartupCommon.portalBlock.getDefaultState().withProperty(PortalBlock.AXIS, this.axis), 2);
                    }
                }
            }
        }
