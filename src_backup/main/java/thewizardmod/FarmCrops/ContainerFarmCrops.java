...
public class ContainerFarmCrops extends Container {
 
    public final TileEntityFarmCrops tileTank;

    public int slotSize = 14;
    
    public ContainerFarmCrops(InventoryPlayer playerInventory, TileEntityFarmCrops te)
    {
        this.tileTank = te;
	...
	public class BoneMealSlot extends Slot {
		...
		@Override
		public boolean isItemValid(ItemStack itemstack) {
        	if(itemstack.areItemsEqual(itemstack, new ItemStack(Items.DYE, 1, 15)))
        	{
        		return true;
        	}
            return false;
