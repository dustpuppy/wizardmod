...
public class GuiFarmFeeder extends GuiContainer {
	...
	private TileEntityFarmFeeder tileEntityTank;

	public GuiFarmFeeder(InventoryPlayer invPlayer, TileEntityFarmFeeder tile) {
		super(new ContainerFarmFeeder(invPlayer, tile));
		tileEntityTank = tile;
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		fontRendererObj.drawString("Feeding Station", 25, 5, Color.darkGray.getRGB());
