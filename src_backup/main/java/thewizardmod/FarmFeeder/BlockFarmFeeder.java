...
public class BlockFarmFeeder extends BlockContainer{
	
	public static final PropertyDirection PROPERTYFACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	public EnumFacing FACING;

	public BlockFarmFeeder() {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		if (fluidHandler != null) {
			...
			{
				playerIn.openGui(TheWizardMod.instance, thewizardmod.TheWizardMod.GUI_ID_FEEDER, worldIn, pos.getX(), pos.getY(), pos.getZ());
			}
		}
		return false;
	}
	...
	public final ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
	  	...
	  	TileEntityFarmFeeder tileEntity = (TileEntityFarmFeeder) world.getTileEntity(pos);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityFarmFeeder();
	}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
		...
		if (tileEntity instanceof TileEntityFarmFeeder) 
		{
			...
			((TileEntityFarmFeeder) tileEntity).setFacing(facing);
		}
	}
