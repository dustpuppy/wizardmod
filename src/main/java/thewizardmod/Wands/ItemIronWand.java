...
public class ItemIronWand extends Item 
{
  ...
  static public final int DISTANCE_POWER = 50;
  static public final int MAX_FOCUS = 2;
  static public final int CHARGE_UP_INITIAL_PAUSE_TICKS = 3;
  static public final int CHARGE_UP_DURATION_TICKS = 12;
  static public final int MAX_DAMAGE = 200; 
   ...
   * But not for wooden or iron wand
   */
  /*
