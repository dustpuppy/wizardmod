...
public class ItemWoodenWand extends Item 
{
  ...
  static public final int DISTANCE_POWER = 30;
  static public final int MAX_FOCUS = 1;
  static public final int CHARGE_UP_INITIAL_PAUSE_TICKS = 3;
  static public final int CHARGE_UP_DURATION_TICKS = 18;
  static public final int MAX_DAMAGE = 100; 
