...
public class EntityAIMiniZombieMoveTo extends EntityAIBase
{
    ...
    public EntityAIMiniZombieMoveTo(EntityCreature creature, double speedIn, int length, int x, int y, int z)
    {
