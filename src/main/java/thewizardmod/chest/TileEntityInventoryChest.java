 ...
 */
public class TileEntityInventoryChest extends TileEntity implements IInventory, ITickable {
	...
	// We use the update to give randomly a new item in one of the slots (that's magic)
	// Only works on the last set chest
	@Override
	public void update() {
	}
