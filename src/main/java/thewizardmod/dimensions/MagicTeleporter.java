...
public class MagicTeleporter extends Teleporter
{
	...
	private final Long2ObjectMap<MagicTeleporter.PortalPosition> destinationCoordinateCache = new Long2ObjectOpenHashMap(4096);
 
	public MagicTeleporter(WorldServer worldIn, int dme2, double x, double y, double z)
	{
 		super(worldIn);
	...
	public boolean makePortal(Entity entityIn)
	{
			...
			for (int j7 = -1; j7 <= 1; ++j7)
			{
				for (int l7 = 1; l7 < 3; ++l7)
				{
					for (int k8 = -1; k8 < 3; ++k8)
					{
						...
						boolean flag = k8 < 0;
						this.worldServerInstance.setBlockState(new BlockPos(k9, k10, k11), flag ? StartupCommon.portalFrame.getDefaultState() : Blocks.AIR.getDefaultState());
		...
		IBlockState iblockstate = StartupCommon.portalBlock.getDefaultState().withProperty(BlockPortal.AXIS, l6 == 0 ? EnumFacing.Axis.Z : EnumFacing.Axis.X);
		...
		for (int i8 = 0; i8 < 4; ++i8)
		{
			for (int l8 = 0; l8 < 4; ++l8)
			{
				for (int l9 = -1; l9 < 4; ++l9)
				{
					...
					this.worldServerInstance.setBlockState(new BlockPos(l10, l11, k12), flag1 ? StartupCommon.portalFrame.getDefaultState() : iblockstate, 2);
