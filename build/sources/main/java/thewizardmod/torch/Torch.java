    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand)
    {
        ...
        double d4 = 0.27D;
  		...
  		if(time < 23500 && time >12800)
  		{
  			...
  			{
  				EnumFacing enumfacing1 = enumfacing.getOpposite();
            	worldIn.spawnParticle(EnumParticleTypes.DRAGON_BREATH, d0 + 0.27D * (double)enumfacing1.getFrontOffsetX(), d1 + 0.22D, d2 + 0.27D * (double)enumfacing1.getFrontOffsetZ(), 0.0D, 0.0D, 0.0D, new int[0]);
  			...
  			{
  				worldIn.spawnParticle(EnumParticleTypes.DRAGON_BREATH, d0, d1, d2, 0.0D, 0.0D, 0.0D, new int[0]);
