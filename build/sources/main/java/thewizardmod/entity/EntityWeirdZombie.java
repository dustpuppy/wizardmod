...
public class EntityWeirdZombie extends EntityZombie {
    ...
    public static final ResourceLocation deathLootTable = new ResourceLocation(TheWizardMod.MODID, "/loot_table/entities/weird_zombie.json");
