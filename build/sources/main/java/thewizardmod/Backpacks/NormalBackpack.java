...
public class NormalBackpack extends Item
{
	public static int backpackSize = 27;
  public NormalBackpack()
  {
...
public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn,
	  ...
	  if(!worldIn.isRemote){
		  playerIn.openGui(TheWizardMod.instance, thewizardmod.TheWizardMod.GUI_ID_NORMAL_BACKPACK, worldIn, 0, 0, 0);
	  }
