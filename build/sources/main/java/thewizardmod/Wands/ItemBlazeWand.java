...
public class ItemBlazeWand extends Item 
{
  // This parameters are differend for every wand
  static public final int DISTANCE_POWER = 100;
  static public final int MAX_FOCUS = 10;
  static public final int CHARGE_UP_INITIAL_PAUSE_TICKS = 1;
  static public final int CHARGE_UP_DURATION_TICKS = 4;
  static public final int MAX_DAMAGE = 500; 


	  
  public ItemBlazeWand() {
