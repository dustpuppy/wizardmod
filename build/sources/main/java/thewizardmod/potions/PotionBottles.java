...
public class PotionBottles extends Item
{
  public PotionBottles() {
    this.setMaxDamage(0);
  ...
  public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityLivingBase entityLiving)
  {
    ...
    /*
     * An dieser stelle verteilen wir dann die effekte der einzendeln zaubertränke
     */
	String s = getUnlocalizedNameInefficiently(stack);
	if(s.equals("item.twm_potion_unlocalised_name.cherry")){
		entityLiving.addPotionEffect(new PotionEffect(MobEffects.NIGHT_VISION, 600, 0));
		fullnessBits = 0;		// set fullness to 0. This way cherry is only useable once 
	}
